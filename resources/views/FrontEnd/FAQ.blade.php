...
<main class="main">
	...
	<div class="page-content">
		<div class="container">
			<h2 class="title text-center mb-3">{{ __('navbar.Shipping') }} {{ __('navbar.Information') }}</h2><!-- End .title -->
			<div class="accordion accordion-rounded" id="accordion-1">
				<div class="card card-box card-sm bg-light">
					<div class="card-header" id="heading-1">
						<h2 class="card-title">
							<a role="button" data-toggle="collapse" href="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
								{{ __('navbar.How will my parcel be delivered?') }}
							</a>
						</h2>
					</div><!-- End .card-header -->
					...
					<div class="card-header" id="heading-2">
						<h2 class="card-title">
							<a class="collapsed" role="button" data-toggle="collapse" href="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
								{{ __('navbar.Do I pay for delivery?') }}							</a>
						</h2>
					</div><!-- End .card-header -->
				...
				<div class="card card-box card-sm bg-light">
					<div class="card-header" id="heading-3">
						<h2 class="card-title">
							...
							{{	__('navbar.Will I be charged customs fees?') }}
							</a>
						</h2>
					</div><!-- End .card-header -->
				...
				<div class="card card-box card-sm bg-light">
					<div class="card-header" id="heading-4">
						<h2 class="card-title">
							...
							{{	__('navbar.My item has become faulty') }}
							</a>
						</h2>
					</div><!-- End .card-header -->
			...
			<h2 class="title text-center mb-3">{{ __('navbar.Orders and Returns')}}</h2><!-- End .title -->
				...
				<div class="card card-box card-sm bg-light">
					<div class="card-header" id="heading2-3">
						<h2 class="card-title">
							...
							{{	__('navbar.How can I return an item?')}}
							</a>
						</h2>
					</div><!-- End .card-header -->
			...
			<h2 class="title text-center mb-3">{{ __('navbar.Payments') }}</h2><!-- End .title -->
				...
				<div class="card card-box card-sm bg-light">
					<div class="card-header" id="heading3-1">
						<h2 class="card-title">
							...
							{{	__('navbar.What payment types can I use?')}}
							</a>
						</h2>
					</div><!-- End .card-header -->
					...
					<div class="card-header" id="heading3-2">
						<h2 class="card-title">
							<a class="collapsed" role="button" data-toggle="collapse" href="#collapse3-2" aria-expanded="false" aria-controls="collapse3-2">
								{{ __('navbar.Can I pay by Gift Card?')}}
							</a>
						</h2>
					</div><!-- End .card-header -->
				...
				<div class="card card-box card-sm bg-light">
					<div class="card-header" id="heading3-3">
						<h2 class="card-title">
							...
							{{ __('navbar.I cant make a payment')}}
							</a>
						</h2>
					</div><!-- End .card-header -->
				...
				<div class="card card-box card-sm bg-light">
					<div class="card-header" id="heading3-4">
						<h2 class="card-title">
							...
							{{ __('navbar.Has my payment gone through?')}}
							</a>
						</h2>
					</div><!-- End .card-header -->
	...
	<div class="cta cta-display bg-image pt-4 pb-4" style="background-image: url({{asset('Frontend/assets/images/Image/Slider/bg-7.jpg')}});">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-10 col-lg-9 col-xl-7">
					<div class="row no-gutters flex-column flex-sm-row align-items-sm-center">
						<div class="col">
							<h3 class="cta-title text-white">{{ __('navbar.If You Have More Questions')}}</h3><!-- End .cta-title -->
							<p class="cta-desc text-white">{{ __('navbar.Please free to contact us')}}</p><!-- End .cta-desc -->
						</div><!-- End .col -->

						<div class="col-auto">
							<a href="{{route('contact')}}" class="btn btn-outline-white"><span>{{ __('navbar.CONTACT US')}}</span><i class="icon-long-arrow-right"></i></a>
						</div><!-- End .col-auto -->
