    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Category grid 2 column</li>
            </ol>
        </div><!-- End .container -->
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="{{route('product', $pro->slug)}}">
                                            <img src="{{asset($pro->image)}}" alt="Product image" class="product-image" style=" height: 400px;
                                        object-fit: cover;">
                                        </a>
