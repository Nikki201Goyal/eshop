                            ...
                            <div class="toolbox-sort">
                                ...
                                <div class="select-custom">
                                    <select name="sortby" id="sortby" class="form-control">
                                        <option value="higher_price" {{ request('sortBy')=='higher_price' ? 'selected' :
                                            null }}>Higher Price</option>
                                        <option value="lower_price" {{ request('sortBy')=='lower_price' ? 'selected' :
                                            null }}>Lower Price</option>
                                        <option value="newness" {{ request('sortBy')=='newness' ? 'selected' : null }}>
                                            Latest</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-6 col-lg-3 order-lg-last">
                                    <div class="product-list-action">
                                        ...
                                        <div class="ratings-container">
                                            <div class="ratings">
                                                <div class="ratings-val"
                                                    style="width: {{ round($pro->avgRating())*20 }}%;"></div>
                                                <!-- End .ratings-val -->
                                            </div><!-- End .ratings -->
                                        ...
                                        <a href="#" class="btn-product btn-cart" title="Add to cart"
                                            ...
                                            product="{{ $pro->id }}"><span>add to
                                                cart</span></a>
                                        @else
                                        <button href="#" class="btn-product btn-cart" title="Add to cart"
                                            disabled><span>Out Of Stock</span></button>
                                        @endif
                                ...
                                <div class="col-lg-6">
                                    <div class="product-body product-action-inner">
                                        <a href="#" class="btn-product btn-wishlist" title="Add to wishlist"
                                            user="@if(Auth::user()) {{  Auth::user()->id }} @else 0 @endif"
                                            product="{{ $pro->id }}"><span>add to wishlist</span></a>

                                        <h3 class="product-title"><a href="{{route('product', $pro->slug)}}">{{
                                            ...
                                            <div class="filter-item">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" name="category[]"
                                                        ...
                                                        value="{{ $cat->slug }}" id="{{ $cat->slug }}" {{ $cat->id ==
                                                    $category->id? 'checked':null }}
                                        ...
                                        object-fit: cover;">
                                                ...
                                                <div class="product-body">
                                                    <h5 class="product-title"><a
                                                            href="{{route('product', $popProduct->slug)}}">{{
                                                            $popProduct->name}}</a></h5><!-- End .product-title -->
                                                    <div class="product-price">
                                                        {{ $popProduct->price }}
                                                    </div><!-- End .product-price -->
                                                </div><!-- End .product-body -->
